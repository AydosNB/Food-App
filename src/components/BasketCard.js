       ...
       <div class="flex justify-end items-center">
         <button
          data-mealid = ${item.idMeal}
           class="delete-basket-btn py-[7px] px-[15px] bg-orange-400 flex justify-center items-center text-gray-800 font-bold rounded-md shadow-sm hover:bg-orange-300 active:scale-95">
